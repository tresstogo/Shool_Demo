        ...
        return(
            <View>
                <View style={{ height:Dimensions.get("window").height*.1, alignItems:"center", justifyContent:"center"}}>
                    <Text style={{fontSize:25}}> Adding Teacher...</Text>
                </View>
                ...
                <View style={styles.inputCon}>
                    <TextInput placeholder={"Subject:"} style={styles.input} onChangeText={
                            change=>this.setState({Subject:change})}>
                    </TextInput>
                </View>
                <View style={styles.inputCon}>
                    <TextInput placeholder={"Experience:"} style={styles.input} onChangeText={
                            change=>this.setState({Experience:change})}>
                    </TextInput>
                </View>
                <View style={styles.inputCon}>
